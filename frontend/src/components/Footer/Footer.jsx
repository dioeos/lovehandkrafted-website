...
const Footer = () => {
  ...
  return (
    <div id="footer-wrapper" className="bg-[#352f36] -mt-[5vh]">
      <div
        id="footer-container"
        className="-mt-[5vh] ml-[2vw] z-100 p-4 flex flex-col justify-end bg-[#352f36]"
      >
        <div id="header" className="relative mb-[10vh] flex flex-col">
          ...
          <div className="">
            <form
              ...
              className=" relative flex items-center h-12 mt-2 manrope text-[0.7em] md:text-[1em] w-[50%]"
            >
              <input
                type="text"
                id="newsletter-email"
        ...
        <div
          id="extras"
          className="flex justify-between satoshi uppercase text-[.7rem] md:text-[1rem]"
        >
