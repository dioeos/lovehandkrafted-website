        ...
        <div id="login-container" className="mt-[4em] p-4 mx-[2vw]">
          <div id="login-header">
            ...
            <div className="block min-h-[1.5rem]">
              {error && (
                <div className="text-red-600 text-sm text-center mb-2 satoshi">
                  {error}
                </div>
              )}
              {success && (
                <div className="text-green-600 text-sm text-center mb-2 satoshi">
                  {success}
                </div>
              )}
            </div>
              ...
              {method === "login" && (
                <div className="satoshi">
                  ...
                  <p className="text-sm text-[#352f36] text-center">
                    <span
                      className="text-blue-600 cursor-pointer satoshi"
                      onClick={() => navigate("/account/password/recover")}
                    >
              ...
              {method === "register" && (
                <div>
                  ...
                  <p className="text-sm text-[#352f36] text-center satoshi">
                    ...
                    <span
                      className="text-blue-600 cursor-pointer satoshi"
                      onClick={() => navigate("/account/verification/resend")}
                    >
                      Resend
                    </span>
                  </p>
