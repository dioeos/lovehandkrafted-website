  ...
  return (
    <div className="satoshi">
      ...
      >
        <div
          id="bar"
          className="flex relative justify-center uppercase text-xs "
        >
          <a
            href="/"
            style={{ color: "#352f36", textDecoration: "none" }}
            className="absolute left-0 mt-1 text-xs md:text-lg"
          >
            Lovehandkrafted
          </a>
          ...
          <div onClick={onClick} className="flex gap-[8px] cursor-pointer ">
            <button
              onClick={onClick}
              className=" border-none cursor-pointer flex justify-start items-start"
            >
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
                className=" flex justify-end items-end md:mt-1.5"
              >
                <motion.path
                  fill="none"
                  stroke="#352f36"
            ...
            >
              ...
              <motion.p
                variants={opacity}
                animate={isActive ? "open" : "closed"}
                className={`absolute text-xs md:text-lg ${isActive ? "block" : "hidden"}`}
              >
                Close
              </motion.p>
            </div>
          ...
          <motion.div
            variants={opacity}
            animate={!isActive ? "open" : "closed"}
            className="absolute flex gap-[30px] right-0 mt-1"
          >
            <p className="hidden md:block md:cursor-pointer md:text-lg">Shop</p>
            <div className="flex gap-[6px] cursor-pointer">
              <svg
                className="h-[20px] w-[20px] sm:h-[25px] sm:w-[25px] md:h-[30px] md:w-[30px]"
                viewBox="0 0 19 25"
                fill="none"
