    ...
    return (
        <div id="header" className="bg-[#f4f0ea] fixed w-full box-border p-2 text-[#0B1215]">
            <div id="bar" className="flex relative justify-center uppercase text-xs ">
                <a href="/" style={{color: "#0B1215", textDecoration: "none"}} className="absolute left-0 mt-1">Lovehandkrafted</a>
                ...
                <div onClick={onClick} className="flex gap-[8px] cursor-pointer ">
                    ...
                    <button onClick={onClick} className=" border-none cursor-pointer flex justify-start items-start">
                        <svg width="24" height="24" viewBox="0 0 24 24" className=" flex justify-end items-end">
                            <motion.path
                                fill="none"
                                stroke="#0B1215"
                                strokeWidth="2"
