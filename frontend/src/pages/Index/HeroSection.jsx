  ...
  return (
    <section id="hero-section" className="p-4 min-h-screen bg-[#FAF9F6]">
      <img
        ...
        src="https://cdn.lovehandkrafted.com/lhk_landing_image.jpg"
      />
      <div ref={heroContainer} id="body" className="ml-[2vw] mt-[40vh]">
        <div className="relative">
          <motion.div
            style={{ y, initial: "0px" }}
            className="m-0 mt-[20px] text-[2rem] md:text-[5.3rem] leading-[30px] md:leading-[4rem] uppercase text-[#fffff0]"
          >
        ...
        <motion.div
          ...
          className=""
        >
          <div className="text-[#fffff0] m-0 uppercase relative">
            <motion.div
              style={{ y: y2, initial: "0px" }}
              className="satoshi text-[1rem] leading-[2px] md:leading-[45px] md:text-[2.2rem]"
            >
              {phrase}
            </motion.div>
          </div>
