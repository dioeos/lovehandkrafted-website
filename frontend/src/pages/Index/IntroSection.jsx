                    ...
                    <div id="sub-text-container" className="manrope flex flex-col text-[.9rem]">
                        ...
                        <div id="sub-text-sm" className="flex gap-2">
                            <motion.div style={{ y, initial: "0px" }} className="">
                                <p className="text-[1em] md:text-[1.5rem] md:w-2/3">Every item in our collection celebrates the uniqueness of handcrafted products.</p>
                            </motion.div>
                            <a className="flex no-underline md:absolute md:ml-[35rem]" href="/about" style={{ textDecoration: 'none' }}>
                                <motion.div 
